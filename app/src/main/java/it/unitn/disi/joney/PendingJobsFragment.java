 ...
 * {@link PendingJobsFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link PendingJobsFragment#newInstance} factory method to
...
public class PendingJobsFragment extends Fragment {
     ...
     * @return A new instance of fragment PendingJobsFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final List<Job> pendingJobs = db.getUserPendingJobs(currentUserId);
        ...
        if(pendingJobs.size() > 0) {
            ...
            expandableListAdapter = new ExpandableJobListAdapter(context, pendingJobs, Constants.POSTED_JOB_TAB);
            ...
            expandableListView.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {
                ...
                public void onGroupExpand(int groupPosition) {
                    Toast.makeText(context,
                            pendingJobs.get(groupPosition).getTitle() + " List Expanded.",
            ...
            expandableListView.setOnGroupCollapseListener(new ExpandableListView.OnGroupCollapseListener() {
                ...
                public void onGroupCollapse(int groupPosition) {
                    Toast.makeText(context,
                            pendingJobs.get(groupPosition).getTitle() + " List Collapsed.",
                            Toast.LENGTH_SHORT).show();
            ...
            expandableListView.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
                ...
                public boolean onChildClick(ExpandableListView parent, View v,
                    ...
                    Toast.makeText(
                            context,
                            pendingJobs.get(groupPosition).getTitle()
                                    + " -> "
                                    + pendingJobs.get(groupPosition).getDescription(), Toast.LENGTH_SHORT
                    ).show();
                    return false;
                }
            });
